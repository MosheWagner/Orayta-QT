...
//		assignDefaults();
	...
	private void assignValues() {
		...
		confParams = line.getOptionValue("params", "");
...
//	}
	...
	private void getOptions(){
		...
		runOptions.addOption( OptionBuilder.withLongOpt( "TH" )
                ...
                .create() );
		runOptions.addOption( OptionBuilder.withLongOpt( "params" )
                .withDescription( "additional parameters to pass to the conf file")
                .hasArgs()
                .withValueSeparator(',')
                .create() );
