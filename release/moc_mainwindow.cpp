...
**
** Created: Thu May 20 22:26:33 2010
...
static const char qt_meta_stringdata_MainWindow[] = {
    ...
    "on_viewTab_currentChanged(int)\0"
    "booklist_ind\0openBook(int)\0"
    "openSelectedBook()\0openSelectedBookInNewTab()\0"
    "collapseItem()\0expandItem()\0pos\0"
    "on_bookmarkWidget_customContextMenuRequested(QPoint)\0"
    "QString\0lnk\0bookMarkTitle(QString)\0"
    "link,title\0addBookMark(QString,QString)\0"
    "bookMarkPosition(QString)\0lnk,title\0"
    "addBookMarkToList(QString,QString)\0"
    "addBookMarkToList(QString)\0"
    "on_bookmarkDown_clicked()\0"
    "on_bookmarkUp_clicked()\0"
    "on_removeBookmark_clicked()\0"
    "buildBookMarkList()\0item\0"
    "on_bookmarkWidget_itemDoubleClicked(QListWidgetItem*)\0"
    ...
    "on_searchBackwords_clicked()\0"
    "on_searchForward_clicked()\0"
    "on_topButton_clicked()\0"
    "on_lineEdit_returnPressed()\0"
    "on_zoomoutButton_clicked()\0"
    "on_zoominButton_clicked()\0"
    "on_removeAllFromSearchButton_clicked()\0"
    "on_addAllToSearchButton_clicked()\0"
    "removeFromSearch()\0addToSearch()\0"
    "on_searchButton_clicked()\0"
    "on_newTabButton_clicked()\0printBook()\0"
    "url\0webView_linkClicked(QUrl)\0"
    "webView_loadStarted()\0progress\0"
    "webView_loadProgress(int)\0"
    "webView_loadFinished()\0item,column\0"
    "on_treeWidget_itemDoubleClicked(QTreeWidgetItem*,int)\0"
    "addViewTab(bool)\0phrase\0simpleSearch(QString)\0"
    "regexp,disp\0SearchInBooks(QRegExp,QString)\0"
    "advancedSearch()\0findBookForm()\0uid\0"
    "menuOpenBook(int)\0about()\0showNikud\0"
    "toggleNikud(bool)\0showTeamim\0"
    "toggleTeamim(bool)\0"
};
